...
public class FruitsDao {
	...
	private final String insert_sql = "insert into fruits values(?,?,?,?)";
	...
	public boolean updateFruits(Fruits obj) {
		return jdbcTemplate.update(insert_sql, obj.getName(),obj.getPrice(),obj.getQuantity(),obj.getId()) > 0;
	}
	
	public boolean deleteFruits(int id) {
		return jdbcTemplate.update(insert_sql, id) > 0;
	}
